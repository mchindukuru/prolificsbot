namespace ProlificsBot.Helpers
{
    ...
    public class GraphHelper
    {
        ...
        public async Task AppinstallationforGroupAsync(string GroupId)
        {
            ...
            try
            {
                var result = await graphClient.AppCatalogs.TeamsApps.Request().GetAsync();
                ...
                var userScopeTeamsAppInstallation = new UserScopeTeamsAppInstallation
                {
                    ...
                    {
                        {"teamsApp@odata.bind", $"https://graph.microsoft.com/v1.0/appCatalogs/teamsApps/a7d44b07-b17a-4c2e-a8f6-79cdd5df0abb"}
                    }
                };

                await graphClient.Chats[GroupId].InstalledApps
                    .Request().AddResponseAsync(userScopeTeamsAppInstallation);
            }
